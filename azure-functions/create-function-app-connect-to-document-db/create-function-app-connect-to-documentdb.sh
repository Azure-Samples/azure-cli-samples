...
az functionapp config appsettings update --name MyFunction --resource-group myResourceGroup --setting myDocumentDBConnectionString="AccountEndpoint=https://mydocumentdb.documents.azure.com:443/;AccountKey=MyKey;"